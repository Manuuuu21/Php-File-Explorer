...
<body>
                        ...
                        <div class="mobile-bulk-actions">
                            <div class="breadcrumb-dropdown">
                                ...
                                <div id="mobile-breadcrumb-dropdown-content" class="breadcrumb-dropdown-content" style="right: 0; left: auto;">
                                    ...
                                    <a id="bulkShareBtn2" onclick="sharePrompt()"><img src="img-icon/file-icon/share-link.png" style="margin-right:9px;width:18px; height:18px; vertical-align:middle;" referrerPolicy="no-referrer" /> Share link</a>
                                    <a id="bulkRenameBtn2" onclick="renamePrompt()"><img src="img-icon/file-icon/rename.png" style="margin-right:9px;width:18px; height:18px; vertical-align:middle;" referrerPolicy="no-referrer" /> Rename</a>
    ...
    <!-- MODALS -->
    <div id="mediaModal" class="modal"><div class="modal-content"><div class="media-header"><div style="display: flex; flex-direction: column; overflow: hidden; gap: 4px;"><span id="mediaTitle">Viewer</span><span id="mediaSubtitle">Preview</span></div><div style="display: flex; align-items: center; gap: 16px;"><button id="pdfSlideshowBtn" class="btn btn-tonal-primary" style="display: none; padding: 8px 16px; border-radius: 20px; font-size: 0.85rem;" onclick="startPdfSlideshow()">📽️ Slideshow</button><button id="rotateVideoBtn" class="btn btn-tonal-primary" style="display: none; padding: 8px 16px; border-radius: 20px; font-size: 0.85rem;" onclick="rotateVideo()">🔄 Rotate</button><span onclick="closeModal('mediaModal')" style="cursor:pointer; font-size:32px; line-height: 1;">&times;</span></div></div><div id="mediaBody"><button class="nav-btn nav-prev" onclick="navigateMedia(-1)">❮</button><div id="mediaContainer"></div><button class="nav-btn nav-next" onclick="navigateMedia(1)">❯</button></div></div></div>
